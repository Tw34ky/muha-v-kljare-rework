...
Этот проект представляет собой веб-панель для удаленного управления дроном Clover, которая включает в себя:
...
- Визуализацию маршрутов и целей
...
7. **Планирование маршрутов**: Добавлена возможность рисовать и сохранять маршруты движения.
